...
function factor_squarefree(x::spoly)
  ...
  bool = (br_type <: Union{Rationals, N_FField, N_ZpField, N_ZnRing, N_AlgExtField, N_Field})
...
function factor(x::spoly)
  R = parent(x)
  br_type = typeof(base_ring(R))
  bool = (br_type <: Union{Rationals, Integers, N_FField, N_ZpField, N_ZnRing, N_AlgExtField, N_Field})
